      ...
      >
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto pt-20 md:pt-24 pb-12">
          ...
          <div className="inline-flex items-center gap-2 bg-white/70 border border-berry-dark/10 rounded-full px-5 py-2 mb-6">
            ...
            <span className="font-cinzel text-xs uppercase tracking-[0.12em] text-[#9A1E61]/80">
              Reviews
            </span>
          </div>

          {/* Titel met kleur #9A1E61 */}
          ...
          <div className="w-16 h-0.5 mx-auto mb-6" style={{ backgroundColor: "#9A1E61", opacity: 0.2 }} />

          <p className="font-body text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed" style={{ color: "#9A1E61", opacity: 0.9 }}>
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2" style={{ color: "#9A1E61", opacity: 0.5 }}>
      ...
      <section className="bg-white py-20 md:py-32">
        <div className="container-main max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-[#9A1E61]/[0.06] border border-[#9A1E61]/10 rounded-full px-5 py-2 mb-6">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#9A1E61" strokeWidth="2">
                <path d="M12 17.27L18.18 21 16.54 13.97 22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
              </svg>
              <span className="font-cinzel text-xs uppercase tracking-[0.12em] text-[#9A1E61]">
                Echte ervaringen
              </span>
            </div>
            ...
            <div className="w-16 h-0.5 mx-auto mb-6" style={{ backgroundColor: "#9A1E61", opacity: 0.3 }} />
            <p className="font-body text-base md:text-lg max-w-2xl mx-auto leading-relaxed" style={{ color: "#9A1E61", opacity: 0.75 }}>
              Lees hieronder de ervaringen van gezinnen die ik heb mogen begeleiden tijdens hun kraamperiode.
            </p>
          </div>

          {/* ═══════ ELFSIGHT WIDGET - GEÏNTEGREERD ═══════ */}
